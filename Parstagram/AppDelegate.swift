...
//  Parstagram
//
//  Created by Sudiksha Sarvepalli on 2/25/20.
//  Copyright © 2020 Sudiksha Sarvepalli. All rights reserved.
//
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(with: ParseClientConfiguration(block:
            { (configuration: ParseMutableClientConfiguration) -> Void in
                ...
                configuration.server = "https://powerful-savannah-50058.herokuapp.com/parse"
        }))
